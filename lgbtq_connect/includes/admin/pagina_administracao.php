        ...
        <div id="editModal" style="display:none;">
            ...
            <form id="editForm" method="post" action="<?php echo admin_url('admin.php?page=lc_admin'); ?>">
                ...
                <div id=editDivBotoes>
                    <button type="button" id="editCancelar" onclick="fecharEditor()">Cancelar</button>
                    <button type="submit" action="atualizar_formulario($wpdb)" id="editSalvar">Salvar</button>
                </div>
            </form>
        </div>
